...
import { ArrowRight, FileText, Github, Linkedin, Facebook, Instagram, Twitter } from "lucide-react";
      ...
      <div className="container relative z-10 px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="inline-block rounded-full bg-muted px-4 py-1.5 text-sm">
            Hello, my name is Albin Varghese 👋
          </div>
          ...
          >
            With over 6 years of experience crafting digital solutions. 
            Based in Kerala, India, I build exceptional, high-performing 
            applications with clean code and intuitive design.
          </motion.p>
