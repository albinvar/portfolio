        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          <div className="space-y-6">
            <div className="aspect-square overflow-hidden rounded-2xl bg-muted relative">
              <Image
                src="https://images.pexels.com/photos/13676746/pexels-photo-13676746.jpeg"
                alt="Albin Varghese"
                fill
          ...
          <div className="space-y-6">
            ...
            <p className="text-muted-foreground">
              I'm a <strong>Full Stack Developer</strong> with over 6 years of experience
              crafting digital solutions. Based in Kerala, India, I specialize in
              building exceptional websites, applications, and everything in between.
            </p>
            
            <p className="text-muted-foreground">
              My journey as a developer began in 2017, and since then, I've worked with
              a diverse range of technologies and frameworks. I'm passionate about
              creating clean, efficient code and delivering user-friendly experiences.
            </p>
        ...
        <div className="mt-24 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="p-6 border rounded-lg">
            ...
            <p className="text-muted-foreground text-sm mt-2">
              Working with various technologies and clients across different industries.
            </p>
          </div>
          ...
          <div className="p-6 border rounded-lg">
            ...
            <p className="text-muted-foreground text-sm mt-2">
              Delivering solutions ranging from small websites to complex enterprise applications.
            </p>
          </div>
          ...
          <div className="p-6 border rounded-lg">
            ...
            <p className="text-muted-foreground text-sm mt-2">
              Building long-term relationships through quality work and excellent communication.
            </p>
          </div>
