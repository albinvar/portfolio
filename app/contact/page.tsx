            ...
            <Card>
              <CardContent className="p-6">
                ...
                <div className="grid grid-cols-4 gap-4">
                  ...
                  >
                    <svg className="h-6 w-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M22.46 6C21.69 6.35 20.86 6.58 20 6.69C20.88 6.16 21.56 5.32 21.88 4.31C21.05 4.81 20.13 5.16 19.16 5.36C18.37 4.5 17.26 4 16 4C13.65 4 11.73 5.92 11.73 8.29C11.73 8.63 11.77 8.96 11.84 9.27C8.28 9.09 5.11 7.38 3 4.79C2.63 5.42 2.42 6.16 2.42 6.94C2.42 8.43 3.17 9.75 4.33 10.5C3.62 10.5 2.96 10.3 2.38 10V10.03C2.38 12.11 3.86 13.85 5.82 14.24C5.19122 14.4197 4.5301 14.4577 3.88 14.35C4.1646 15.1989 4.7158 15.9362 5.46151 16.4547C6.20723 16.9732 7.10489 17.2443 8.02 17.23C6.4674 18.4517 4.50695 19.1292 2.5 19.13C2.16 19.13 1.82 19.11 1.48 19.07C3.5 20.29 5.89 21 8.46 21C16 21 20.1 14.46 20.1 8.79C20.1 8.6 20.1 8.42 20.09 8.23C20.92 7.63 21.64 6.87 22.22 6" fill="currentColor" />
                    </svg>
                  </Link>
                  <Link
